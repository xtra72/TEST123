...
extern void vEFMEnergyEnter(uint32_t expected);
...
#define configPRE_SLEEP_PROCESSING vEFMEnergyEnter
...
#else
#define configMINIMAL_STACK_SIZE				(( unsigned short ) 42)
#endif
...
#define configMAX_API_INTERRUPT_PRIORITY	configLIBRARY_MAX_SYSCALL_INTERRUPT_PRIORITY
#define configMIN_API_INTERRUPT_PRIORITY	configLIBRARY_LOWEST_INTERRUPT_PRIORITY
...
#define configASSERT( x )	if( ( x ) == 0 ) { taskDISABLE_INTERRUPTS(); SystemReboot(); }
#endif
...
// User defined heap declaration
static inline void *pvPortMalloc( size_t xSize ) { return NULL; };
